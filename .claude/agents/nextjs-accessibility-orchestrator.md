...
description: Top-level accessibility orchestrator. Targets WCAG 2.2 Level AA. Two modes: - **Audit mode** (default): the auditor produces a report of violations; no code changes
model: sonnet
