...
description: Security orchestrator targeting OWASP Top 10 (2021) for Next.js apps. Two modes mirror the a11y orchestrator: - **Audit mode** (default): each sub-auditor produces a findings report
model: sonnet
