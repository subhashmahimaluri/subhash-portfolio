...
description: Scans the codebase for accidentally-exposed secrets. Three categories: 1. Hardcoded secrets in source files 2. Server-only secrets accidentally exposed via `NEXT_PUBLIC_*` env vars
...
# Copilot Agent: secret-leak-auditor
